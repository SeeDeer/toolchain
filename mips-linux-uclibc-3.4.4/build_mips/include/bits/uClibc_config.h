...
#define __KERNEL_HEADERS__ "/opt/build/gcc-3.4.4-2.16.1/toolchain_build_mips/linux/include"
...
#define __CROSS_COMPILER_PREFIX__ "/opt/build/gcc-3.4.4-2.16.1/build_mips//bin/mips-linux-uclibc-"
